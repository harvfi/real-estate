      ...
      <main>
        ...
        <section id="services" className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif mb-4">Our Core Expertise</h2>
            <div className="w-24 h-1 bg-yellow-600 mx-auto mb-6"></div>
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
              Tailored investment strategies designed to build sustainable wealth and generational legacies.
            </p>
          </div>
          <Services />
        </section>
        ...
        <section id="about" className="py-24 bg-[#0a0a0a]">
          <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <span className="text-yellow-600 font-bold tracking-widest uppercase text-sm">About Blackstar</span>
              <h2 className="text-4xl md:text-5xl font-serif mt-4 mb-6 leading-tight">Navigating Complexity with Precision</h2>
              <p className="text-gray-400 text-lg mb-8 leading-relaxed">
                At Blackstar Investments, we believe that wealth is more than just numbers—it's about the freedom to build a life on your own terms. Our team combines deep market knowledge with a commitment to individual success.
              </p>
                   ...
                   <form onSubmit={handleContactSubmit} className="space-y-6">
                     ...
                     <div className="space-y-1">
                        ...
                        <select className="w-full bg-white/5 border border-white/10 rounded-lg p-3 focus:outline-none focus:border-yellow-600 appearance-none">
                            <option className="bg-black">Real Estate Strategy</option>
                            <option className="bg-black">Wealth Management</option>
                            <option className="bg-black">Portfolio Diversification</option>
                        </select>
                     </div>
                     <div className="space-y-1">
